//Esto es info sencilla que se puede ver en https://www.aprendejavascript.dev/ de MiduDev
...
/* Pueden usar los operadores aritméticos para realizar operaciones matemáticas. 
...
console.log("7 ", 'Esto es una cadena de texto con comillas simples');
console.log("8 ", "Esto es una cadena de texto con dobles comillas");
console.log("9 ", `Esto es una cadena de texto con apóstrofo`);
...
console.log("11 ", "Estás aprendiendo " + "JavaScript");

//Booleanos: Los booleanos representa sólo dos valores: true (verdadero) o false (falso)

console.log("12 ", "¿Está lloviendo (true) o no está lloviendo (false)?");
console.log(
  "13 ",
...
console.log("18 ", "JavaScript" === "JavaScript");
console.log("19 ", "JavaScript" === "Java");
